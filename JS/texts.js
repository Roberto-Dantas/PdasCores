...
function writingInserting(number) {
    ...
    if(number === 1) {
        theMonth={title: "Preto/Negro/Black", titleText:"Preto", img:"./Imagens/cores/preto.jpeg",text:""}
        setTimeout(function(){
    ...
    if(number === 2) {
        theMonth={title: "Rosa Claro/Rosa Pálito/Peach", titleText:"Rosa Claro", img:"./Imagens/cores/rosaClaro.jpeg",text:""}
        setTimeout(function(){
    ...
    if(number === 3) {
        theMonth={title: "Rosa Chiclete/Rosa Chicle/Bubblegum pink", titleText:"Rosa Chiclete", img:"./Imagens/cores/rosa.jpeg",text:""}
        setTimeout(function(){
    ...
    if(number === 4) {
        theMonth={title: "Vermelho/Rojo/Red", titleText:"Vermelho", img:"./Imagens/cores/vermelho.jpeg",text:""}
        setTimeout(function(){
    ...
    if(number === 5) {
        theMonth={title: "Laranja/Naranja/Orange", titleText:"Laranja", img:"./Imagens/cores/laranja.jpeg",text:""}
        setTimeout(function(){
    ...
    if(number === 6) {
        theMonth={title: "Amarelo Canário/Amarillo Vivo/Yellow", titleText:"Amarelo Canário", img:"./Imagens/cores/amareloCanario.jpeg",text:""}
        setTimeout(function(){
    ...
    if(number === 7) {
        theMonth={title: "Verde Folha/Verde Hoja/Yellow Green", titleText:"Verde Folha", img:"./Imagens/cores/verdeFolha.jpeg",text:""}
        setTimeout(function(){
    ...
    if(number === 8) {
        theMonth={title: "Verde/Verde/Green", titleText:"Verde", img:"./Imagens/cores/verde.jpeg",text:""}
        setTimeout(function(){
    ...
    if(number === 9) {
        theMonth={title: "Azul/Azul/Light Blue", titleText:"Azul", img:"./Imagens/cores/Azul.jpeg",text:""}
        setTimeout(function(){
    ...
    if(number === 10) {
        theMonth={title: "", titleText:"", img:"", text:""}
        setTimeout(function(){
    ...
    if(number === 11) {
        theMonth={title: "Carmim/Púrpura Vivo/Red Violel", titleText:"Carmim", img:"./Imagens/cores/carmim.jpeg",text:""}
        setTimeout(function(){
